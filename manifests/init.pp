...
class auditd (
  ...
  String $log_group,
  Enum['yes', 'no'] $write_logs,
  Integer $priority_boost,
  Enum['none', 'incremental', 'incremental_async', 'data', 'sync'] $flush,
  Integer $freq,
  Integer $num_logs,
  ...
  Enum['none', 'hostname', 'fqd', 'numeric', 'user'] $audisp_name_format,
